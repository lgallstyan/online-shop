...
public class AuthenticationService {
    ...
    public AuthenticationResponse addCustomer(AddUserDto customerDto) throws UserAlreadyExistsException {

        Optional<User> existUser = userRepository.findByEmail(customerDto.getEmail());
