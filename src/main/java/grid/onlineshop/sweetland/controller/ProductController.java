...
public class ProductController {
    ...
    public ResponseEntity<Product> addProduct(@RequestBody ProductDto product) throws Exception {
    ...
    public ResponseEntity<Product> updateProduct(@RequestBody ProductDto product) throws BadRequestException, ProductNotFoundException, IOException {
