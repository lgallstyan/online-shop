...
public class UserController {
    ...
    public ResponseEntity<AuthenticationResponse> addCustomer(@RequestBody AddUserDto customerRegisterDTO) throws UserAlreadyExistsException {
        AuthenticationResponse addUser = authenticationService.addCustomer(customerRegisterDTO);
