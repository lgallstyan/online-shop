...
public class OrdersController {
    ...
    public ResponseEntity<List<Orders>> viewOrdersWithSortingAsc(@RequestParam("sortBy") String sortBy)
			throws OrdersException {
        return new ResponseEntity<>(ordersService.viewOrdersWithSortingAsc(sortBy), HttpStatus.ACCEPTED);
    }
    ...
    public ResponseEntity<List<Orders>> viewOrdersWithPaginationAndSortingAsc(
        ...
        return new ResponseEntity<>(ordersService.viewOrdersWithPaginationAndSortingAsc(pageNo, pageSize, sortBy),
                HttpStatus.ACCEPTED);
    }
