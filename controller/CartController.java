...
public class CartController {
	...
	public ResponseEntity<Double> findTotalCartPriceByCustomerId(@PathVariable("customerId") Long customerId) throws CartException {
		Double totPrice = cartService.findTotalCartPriceByCustomerId(customerId);
